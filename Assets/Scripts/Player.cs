...
public class Player : MonoBehaviour
{
    ...
    void FixedUpdate()
    {
        ...
        rb.linearVelocity += transform.rotation * ((Input.acceleration.x - xatstart) * Vector3.right * 15f) * Time.deltaTime;
        rb.linearVelocity += transform.rotation * ((Input.acceleration.y - yatstart) * Vector3.up * 15f) * Time.deltaTime;
    }
